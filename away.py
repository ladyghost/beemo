            ...
            for mention in tmp:
                if mention.mention in data:
                    if data[mention.mention]['MESSAGE'] is True:
                        msg = '{} is currently away. Send her a PM if you have any questions.'.format(mention.name)
                    else:
                        msg = '{} is currently away. Send her a PM if you have any questions.'.format(mention.name, data[mention.mention]['MESSAGE'])
