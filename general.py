...
class General:
    ...
    def __init__(self, bot):
        self.bot = bot
        self.stopwatches = {}
        self.ball = ["Definitely!", "Yes!", "Yes.", "No!", "No.", "I want to say yes, but no.", "Yeah right.", "LOL no.", "Pls no.", "Yesss.",
                     "Ummmmmmm, no.", "Actually, yes.", "Totally.", "Heck no.", "I don't feel like answering that.", "Nooooooo",
                     "NO.", "YES.", "Yes! Jk, no.", "No no no no no", "You're funny.", "Not in a million years.", "Duh.",
                     "Don't count on it.", "My reply is no.", "Not gonna answer that.", "I don't think so,", "I doubt it.", "Yes. I mean, no.", "Get out.", "Uhhhh. Service unavailable. Please try again.", "There's a better chance of Sara hating lasagna.", "Nah"]
        self.poll_sessions = []
    ...
    @commands.command()
    async def urbann(self, *, search_terms : str, definition_number : int=1):
