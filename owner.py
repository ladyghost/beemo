...
class Owner:
    ...
    async def _set(self, ctx):
        """Changes Beemo's global settings."""
    ...
    @commands.command()
    async def info(self):
        """Shows info about Beemo"""
        await self.bot.say(
        "My name is Beemo. I'm a Discord bot powered by Javascript and made by "
        "Lady Ghost.\n\n**Website:**\n"
        "<http://ard3nt.com>\n"
        "**Beemo Source:**\n<Coming soon!>")
