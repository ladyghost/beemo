...
class Heist:
    ...
    def __init__(self, bot):
        ...
        self.good = [["{} had the car gassed up and ready to go +25 points.", 25],
                     ["{} fought a guard dog +50 points.", 50],
                     ["{} ran inside and threw a flashbang +50 points.", 50],
                     ["{} cracked the firewall +50 points.", 50],
                     ["{} called an airstrike +50 points.", 50],
                     ["{} whipped out his dick for Harambe +50 points.", 50],
                     ["{} held off the police +50 points.", 50],
        ...
        self.bad = ["A shoot out with local authorities began and {} was hit.\n```{} dropped out.```",
                    ...
                    "{} tripped on his own gun and shot himself\n```{} dropped out.```",
                    "{} accidentally called 911 like a blonde\n```{} dropped out.```",
                    ...
                    "{} got distracted by Sara in her yoga pants and was shot in the head\n```{} dropped out.```",
    ...
    async def _play_heist(self, ctx, bet: int):
        """You need to place a bet between 50 and 1000"""
        ...
        if bet >= 50:
            if self.account_check(user):
                        ...
                        if self.heist_started(settings):  # Checks if a heist is currently happening
                            if self.heist_plan(settings):  # checks if a heist is being planned or not
                                ...
                                if bet >= settings["Config"]["Min Bet"]:
                                    ...
                                    await self.bot.say("Your bet must be equal to or greater" +
                ...
                await self.bot.say("You need a bank account to place bets. Type `beemobank register`.")
        else:
    ...
    def check_server_settings(self, server):
        if server.id not in self.system["Servers"]:
            self.system["Servers"][server.id] = {"Players": {},
                                                 ...
                                                 "Heist Winners": {},
                                                 "Banks": {"Lvl 1 Bank": {"Name": "Bank Level 1", "Crew": 3, "Multiplier": 0.25, "Success": 46, "Vault": 200000, "Max": 200000},
                                                           "Lvl 2 Bank": {"Name": "Bank Level 2", "Crew": 5, "Multiplier": 0.31, "Success": 40, "Vault": 500000, "Max": 500000},
                                                           "Lvl 3 Bank": {"Name": "Bank Level 3", "Crew": 8, "Multiplier": 0.35, "Success": 37, "Vault": 800000, "Max": 800000},
                                                           "Lvl 4 Bank": {"Name": "Bank Level 4", "Crew": 10, "Multiplier": 0.42, "Success": 32, "Vault": 1200000, "Max": 1200000},
                                                           "Lvl 5 Bank": {"Name": "Bank Level 5", "Crew": 15, "Multiplier": 0.5, "Success": 28, "Vault": 2000000, "Max": 2000000},
                                                           },
                                                 }
            dataIO.save_json(self.file_path, self.system)
