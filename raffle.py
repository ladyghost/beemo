...
class Raffle:
    ...
    async def start(self, ctx):
        ...
        if not self.raffle["Config"]["Active"]:
            ...
            await self.bot.say("@everyone a raffle has been started by Lady Ghost! Use the command 'beemoraffle buy <amount>' to purchase tickets. Raffle tickets cost 1000 credits. Replace `<amount>` with the number of tickets you'd like to purchase. Winner will receive 500,000 credits. To check how many tickets you've already purchased, use command `beemoraffle check`. May the odds be ever in your flavor.")
        else:
